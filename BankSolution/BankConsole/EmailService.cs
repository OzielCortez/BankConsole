...
public static class EmailService
{
    public static void SendMail()
    {
        ...
        message.From.Add(new MailboxAddress("Oziel Cortez", "ozielcortez.jmz@gmail.com"));
        message.To.Add(new MailboxAddress("Admin", "ozielcortez.jmz@gmail.com"));
        ...
        using (var client = new SmtpClient())
        {
            ...
            client.Authenticate("ozielcortez.jmz@gmail.com", "ylifojtqqzlaypxz");
            client.Send(message);
